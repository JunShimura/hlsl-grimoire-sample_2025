...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    // シェーダーファイルのパスを指定
    spriteInitData.m_fxFilePath = "Assets/shader/sample_XX.fx";
    ...
    // ワイプサイズ
    Vector2 rateParameter = { 0,0 };
    spriteInitData.m_expandConstantBuffer = &rateParameter;
    spriteInitData.m_expandConstantBufferSize = sizeof(rateParameter);
    ...
    while (DispatchWindowMessage())
    {
        ...
        r += sinf(frameCount * 0.05f);
		rateParameter.x = fmod(rateParameter.x+sinf(r) / 20.0f,1.0);
		rateParameter.y = sinf(frameCount/133.0f);
