...
{
	m_vertexShader.LoadVS("Assets/shader/sampleobjPolygon.fx", "VSMain");
	m_pixelShader.LoadPS("Assets/shader/sampleobjPolygon.fx", "PSMain");
...
void LoadObjPolygon::InitVertexBuffer(char *path )
{
    if (path == nullptr)
    {
